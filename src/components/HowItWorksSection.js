      ...
      <Grid container justify="center" direction="column" alignItems="center">
        ...
        >
          ...
          >
            ...
            >
              CheckMyNFT rates your NFT asset storage based on the reliability
              of the provider used and whether the asset is linked directly to
              the ERC-721 token. <br />
              <br />
              Centralized providers such as AWS S3, Dropbox and Google Drive are
              considered the least desirable as there is a risk that the assets
              could be lost if the NFT issuer or storage provider ceases
              operations or payment. Decentralized providers are most desirable
              with{" "}
              ...
              being of the highest stength. Assets stored using IPFS rely on the
              goodwill of the people storing it. IPFS acts more as a map telling
              you where a specific piece of data resides, but does not
          ...
          >
            ...
            >
              ...
              CheckMyNFT allows you to upload your file that resides on IPFS to
              Arweave where it will be permanently available!
              <br />
              <br />
              We use{" "}
              <a
              ...
              to permanently deploy the asset from IPFS to Arweave. To do this,
              ipfs2arweave take the asset’s IPFS Hash, stores the data onto
              Arweave and pins it to IPFS.
              <br /> <br />
